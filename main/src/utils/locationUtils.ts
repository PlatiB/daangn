 ...
 */
export const getLocationsByDistrict = (locations: Location[], district: string): Location[] => {
 ...
 * @returns 인기 지역 배열
 */
export const getPopularLocations = (locations: Location[]): Location[] => {
 ...
 * @returns 검색 결과 지역 배열
 */
export const searchLocationsByName = (locations: Location[], searchTerm: string): Location[] => {
 ...
 * @returns Location 객체 또는 undefined
 */
export const getLocationByCode = (locations: Location[], code: string): Location | undefined => {
 ...
 */
export const getLocationsByDistrictMap = (locations: Location[]): Map<string, Location[]> => {
 ...
 * @returns 인기 지역 개수
 */
export const getPopularLocationCount = (locations: Location[]): number => {
